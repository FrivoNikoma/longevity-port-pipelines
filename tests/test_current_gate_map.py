...
def test_current_gate_map_records_first_tp53_mdm2_curated_negatome_result() -> None:
    text = read_doc("docs/current_gate_map.md")

    for required in (
        "First TP53/MDM2 curated NEGATOME interface-control result checkpoint",
        "tp53_mdm2_first_curated_negatome_interface_control_results.csv#1",
        ...
        "embedding-based NEGATOME control ratio",
...
def test_current_gate_map_records_first_tp53_mdm2_control_closure_result() -> None:
    text = read_doc("docs/current_gate_map.md")

    for required in (
        "First TP53/MDM2 control-closure result checkpoint",
        "tp53_mdm2_first_control_closure_results.csv#1",
        "aggregates four already committed results",
        ...
        "5c9b77284294997ad5067be4a6991a54892bf883f9d91c0e334004d9068089c0",
        "`W23G`",
        "informational, not a runtime failure",
        ...
        "protein length",
        "arbitrary sequence similarity",
        "does not mean biological approval",
